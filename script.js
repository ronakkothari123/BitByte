...
createProduct("blue", "BitFolio", "An Online Social Media dedicated to showcase your personal achievements, advancements, qualifications, etc. The Best Online Hub for employees and employers everywhere!", "ALPHA")
createProduct("purple", "BitSports", "Online Fantasy Sports platform for players around the world. Is not constricted to one location, and is free to play! It is The Number One Fantasy Sport application in the world!", "BETA")
...
createProduct("yellow", "BitLearn", "A Website dedicated to helping people learn about everyday necessities, whilst making it fun and easy. Our curriculum emphasizes user understanding, and has an online community to help.", "ALPHA")
